...
// RoutePrefixMath — the CIDR overlap/containment arithmetic this file's
// RuleStatus uses — now lives in Shared/RoutePrefixMath.swift so the Shared
// config validators (which compile into the extension too) share the one copy.
